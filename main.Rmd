---
title: Has there been a polarization of working hours? Analysis of the European Union
  Labor Force Survey
output:
  html_document:
    df_print: paged
...
##Means of the number of hours actually worked in main job per week 
###An histogram of the mean of the number of hours actually worked in main job per week, by year
...
```
Figure 1. **Average weekly working hours are declining over time**. Bar chart of average weekly working hours over time. Arithmetic mean of usual working hours, 31 countries from the 2014 release of the EU Labor Force Survey, own analyses.



###An histogram of the mean of the number of hours actually worked in main job per week, by country  
...
Figure 2. **Average weekly working hours varie considerably between countries.** Values range from 27.46 hours a week in the Netherlands to 40.10 in Greece, with an average for the 31 countries of **34.63** (represented by the red line on the graph).Arithmetic mean of usual working hours, 31 countries from the 2014 release of the EU Labor Force Survey, own analyses.
...
Figure 3. **The vast majority of Europeans work between 35 and 40 hours a week but those who work the 20 and 60 hours represent both strong minorities**. Density of the number of hours usually worked (in red) and density of the number of hours people wish to work (in black), all years combined. 31 countries from the 2014 release of the EU Labor Force Survey, own analyses.
...
Figure 4. **A majority of workers wish to conform to the norm**. Density of the number of hours usually worked (in red) and density of the number of hours people wish to work (in black), all years combined. 31 countries from the 2014 release of the EU Labor Force Survey, own analyses.
...
Figure 9. **On average, Romanians work as much as other Europeans, but a very strong minority does not work**. Density of the number of hours usually worked in Romania. From the 2014 release of the EU Labor Force Survey, own analyses.
...
We may analyse data for an other specific country, for instance Austria.
