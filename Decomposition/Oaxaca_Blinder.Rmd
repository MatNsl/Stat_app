...
# Deleted arguments: eulfs_oaxaca, log_group; added: res
# Deleted: results <- eulfs_oaxaca %>% oaxaca::oaxaca(formula = hwactual ~ age + hatlev1d + as.factor(degurba) | log_group, data = eulfs_oaxaca)
...
```
*Figure 1*: The endowments and coefficients components of a threefold Blinder-Oaxaca decomposition of the men vs. women working hours gap.
