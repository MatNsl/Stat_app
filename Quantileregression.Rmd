...
```{r}
# Regressions for a given year (sex, educ)
eulfs_small_year <- subset(eulfs_small, refyear == 2013)
...
```{r}
# Regressions on (sex, age, educ), 2013
eulfs_small_year <- subset(eulfs_small, refyear == 2013)
...
```{r}
# Regression on  (sex, age, educ) for 1998, 1999 and 2000, no cluster
...
```{r}
# Regression on  (sex, age, educ) for 1998, 1999 and 2000, cluster on refyear
# doesn't work yet
